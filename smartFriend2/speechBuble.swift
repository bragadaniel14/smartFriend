...
//  smartFriend2
//
//  Created by Daniel Braga on 8/6/18.
...
public extension UIView {
    ...
    public func addPikeOnView( side: PeakSide, size: CGFloat = 50.0) {
        print("I am entering addPikeOnView")
        self.layoutIfNeeded()
    ...
    func makePeakPathWithRect(rect: CGRect, topSize ts: CGFloat, rightSize rs: CGFloat, bottomSize bs: CGFloat, leftSize ls: CGFloat) -> CGPath {
        print("I am entering makePeakPathWithRect")
        //                      P3
        //                    /    \
        //      P1 -------- P2     P4 -------- P5
        //      |                               |
